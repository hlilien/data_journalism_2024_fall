...
```{r echo=FALSE}
census_api_key("03183f1d7157fca8529a26898cff8c1b802565ed", install = TRUE, overwrite=TRUE)
```
...
```{r}
# Clean names and calculate proportion
early_voting <- county_2024 |> 
  clean_names() |> 
  mutate(proportion_eligible_voters = total__voters / population * 100)

# Calculate simple correlation
correlation <- cor(early_voting$proportion_eligible_voters, early_voting$percent_total, use = "complete.obs")
print(correlation)

# Quick summary of demographics
summary <- early_voting |> 
  select(county_name, median_income, unemployment_rate, percent_total) |> 
