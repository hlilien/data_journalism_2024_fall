...
**https://datawrapper.dwcdn.net/TMZAo/1/ The trend shows that after the COVID-19 pandemic, Election Day voting nearly returned to pre-pandemic levels, as seen between 2018 and 2022. It will be interesting to see how this trend evolves in the 2024 election. **
...
**https://datawrapper.dwcdn.net/0TvOo/1/  I chose 18-24-year-olds' early voting turnout, assuming most young adults would procrastinate and vote later. The graph confirmed this, showing turnout increased as early voting progressed.** 
...
**ActBlue: https://datawrapper.dwcdn.net/B0Kpk/1/  WinRed: https://datawrapper.dwcdn.net/Nwh2t/2/ . The ActBlue map has 10x more donations than WinRed, with both focused on 5-6 DC zip codes. WinRed donations are more spread out. The main question is why donations are so concentrated, likely due to larger populations in those areas.** 
