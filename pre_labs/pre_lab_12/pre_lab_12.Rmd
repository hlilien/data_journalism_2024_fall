...
**Task** Run the following code and describe the dataframe it outputs. **The 'releases' dataframe has text from press releases and other details.**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **The 'unique' function removes duplicates but treats something like 'Dog' and 'dog' as different**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **The 'unnest_tokens' function breaks text into lowercase words and removes punctuation to make things more consistent.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **The chart shows common words like 'and' and 'the', which don't matter much.**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Removing these pause words leaves more relevant words for analysis.**
...
**Task** Run the following code and describe the results. **In 2022, "health" is a common word. In 2024, "baltimore" is pops up a lot.**
...
**Task** Run the following code and describe the results. **The top phrases for 2022 are "health care," "human rights," and "chesapeake bay."**
...
**Task** Run the following code and describe the results. **The top phrase for 2024 is "baltimore city".**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Some of this seems inaccurate, but overall they show positive or negative themes.**
