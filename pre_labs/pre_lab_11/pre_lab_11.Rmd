...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **The columns have the names of candidates and show their votes in each county, but the names are long and a bit messy.**
...
**Task** Run the following code in the gray-colored codeblock below to find the <li> tags. What does the output suggest about how many <ul> tags there are in the HTML source? **There are several <ul> tags because we see a lot of <li> items.**
...
**Task** Run the following code in the gray-colored codeblock below to find the text inside <li> tags. Describe the output: **There are several <ul> tags because we see a lot of <li> items**
...
### Task 11: Turn the contents of the <li> and <a> tags into a dataframe **Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **The output is a table with two columns: one for committee names and one for their links. Now it’s easy to work with.**
