...
**Answer: This shows the number of contributions or the people that are part of the full dataset**
...
**Answer:The "count_contribs" per date are larger in this set compared to the one before**
...
**Answer: This showed different ways the data could be used/presented**
...
**Answer: Total amount per dataset which the previous one did not give us.**
...
**Answer: This gave the mean and median amount**
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **Answer: This gave all of the dataset values/numbers**
