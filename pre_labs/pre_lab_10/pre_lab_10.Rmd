...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **There are 10 columns in the data. Columns like PRECINCT_ID and PRECINCT_NAME are a couple.**
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **It shows information about pc precincts.**
...
**Task** Run the following code. Describe the output in the space below. **It is a precinct map of pg.**
...
**Task** Run the following code. Describe the output in the space below. **I couldn't see this output.**
...
**Task** Run the following code. Describe the output in the space below. **It is a chart of counties.**
...
**Task** Run the following code. Describe the output in the space below. **It is saying the object 'cannot be coerced to type 'double'.**
...
**Task** Run the following code. Describe the output in the space below. **Maryland county boundaries map**
...
**Task** Run the following code. Describe the output in the space below. **Precincts on Maryland counties map**
...
**Task** Run the following code. Describe the output in the space below. **Summary of voter turnout in Prince George's County.**
...
**Task** Run the following code. Describe the output in the space below. **Joins precinct and turnout data**
...
**Task** Run the following code. Describe the output in the space below. **Map colored by eligible voter count per precinct.**
...
**Task** Run the following code. Describe the output in the space below. **Maryland counties listed by total voters**
...
**Task** Run the following code. Describe the output in the space below. **Maryland county population counts**
...
**Task** Run the following code. Describe the output in the space below. **County Population**
...
**Task** Run the following code. Describe the output in the space below. **Adds boundary data**
...
**Task** Run the following code. Describe the output in the space below. **MD voters for counties**
...
**Task** Run the following code. Describe the output in the space below. **Ready for join with voter data**
...
**Task** Run the following code. Describe the output in the space below. **Combines population and voter data**
...
**Task** Run the following code. Describe the output in the space below. **Coded map**
...
**Task** Run the following code. Describe the output in the space below. **Highlights differences with color**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Makes county variations clearer**
...
**Task** Run the following code. Describe the output in the space below. **Calculates unaffiliated voters per 10,000**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see, especially on the ends of the scale? **Map showing patterns with unaffiliated voter**
